    ...
    return (
      ...
      >
        <View style={buttonStyles}>
          {loading ? (
            <ActivityIndicator
              color={outlined ? Colors.primary[600] : Colors.white}
            />
          ) : (
            <>
              {iconPosition === "left" && (
...
const styles = StyleSheet.create({
  ...
  buttonDisabled: {
    ...Platform.select({
      ios: {
        backgroundColor: Colors.gray["300"], //use color picker to change it to a lighter shade of red
      },
      android: {
        elevation: 0,
        backgroundColor: Colors.gray["300"], // same for this
      },
    }),
  },
  textDisabled: {
